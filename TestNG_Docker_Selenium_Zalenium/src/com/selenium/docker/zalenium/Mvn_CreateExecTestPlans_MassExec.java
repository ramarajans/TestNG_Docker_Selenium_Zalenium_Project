...
public class Mvn_CreateExecTestPlans_MassExec{
	...
	public static void main(String[] args) throws Exception {
		...
		excelFilePath = System.getProperty("user.home") + "//OneDrive - SAP SE//Desktop//CreateAndRunTestPlans//ScopeItems1.xlsx";
		configFilePath = System.getProperty("user.home") + "//OneDrive - SAP SE//Desktop//CreateAndRunTestPlans//ScopeItems.xlsx";
		...
		for(int i=0;i<scopeItems.size();i++){
			...
			Thread.sleep(15000);
			System.out.println((i+1)+" out of "+scopeItems.size()+" test plans executed");
