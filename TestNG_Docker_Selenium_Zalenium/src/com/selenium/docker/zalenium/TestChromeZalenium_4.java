...
public class TestChromeZalenium_4 {
	
	@Test
	public void googleSearch2()throws InterruptedException, MalformedURLException{
		
		System.out.println("Running Test in Docker container <<Chrome4 Zalenium>>");
		long id = Thread.currentThread().getId();
		System.out.println("googleSearch Crome 4 , the thread count is: " + id);
		...
		Thread.sleep(20000);
		driver.findElement(By.xpath("//input[text()='Series']")).click();
		
		System.out.println("Search completed(Chrome4 Zalenium)");
	}
