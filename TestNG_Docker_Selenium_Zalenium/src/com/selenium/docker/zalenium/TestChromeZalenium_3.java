...
public class TestChromeZalenium_3 {
	
	@Test
	public void googleSearch2()throws InterruptedException, MalformedURLException{
		
		System.out.println("Running Test in Docker container <<Chrome3 Zalenium>>");
		long id = Thread.currentThread().getId();
		System.out.println("googleSearch Crome 3 , the thread count is: " + id);

		DesiredCapabilities cap = new DesiredCapabilities();
		cap.setBrowserName("chrome");
		cap.setCapability("zal:name", "Chrome Test3");
		...
		System.out.println("Search completed(Chrome3 Zalenium)");
	}
